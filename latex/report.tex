...
Comparison at 8 aligned frames for $(h-h_0,q_x,q_y)$ with \texttt{compare\_TF=4.0} and \texttt{compare\_ic=random}. Both rollouts start after warmup time $T=4.0$. Final rollout metrics for this run: mean L1 error $0.019689$, max-frame L1 error $0.035157$, spectral runtime $151.348$\,s, NN runtime $14.2391$\,s, speedup $10.6\times$.
