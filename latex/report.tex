...
\begin{table}[H]
  ...
  \begin{tabular}{ll}
    ...
    Patch half-width $n_{\mathrm{st}}$ & 16 \\
    Interior width $n_{\mathrm{wd}}$ & 32 \\
    Viscosity $\nu_h$ & 0 \\
...
Comparison at 8 aligned frames for $(h-h_0,q_x,q_y)$ with \texttt{compare\_TF=3.0} and \texttt{compare\_ic=random}. Both rollouts start after warmup time $T=6.0$. Final rollout metrics for this run: mean L1 error $0.026660$, max-frame L1 error $0.052709$, spectral runtime $108.784$\,s, NN runtime $11.1522$\,s, speedup $9.76\times$.
