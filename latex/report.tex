...
\begin{table}[H]
  ...
  \begin{tabular}{ll}
    ...
    Patch half-width $n_{\mathrm{st}}$ & 10 \\
    Interior width $n_{\mathrm{wd}}$ & 32 \\
    Warmup time & 4.0 \\
    Compare $T_F$ & 3.0 \\
    Compare frames & 8 \\
    ...
    TV smooth weight & [0.0, 0.02, 0.02] \\
...
Comparison at 6 output times over $t\in[0,2]$ with \texttt{compare\_t\_end=2.0}. Runtime for this run: FV total $4.166$\,s, NN total $0.3310$\,s, speedup $12.59\times$.
...
Comparison at 6 aligned frames with \texttt{compare\_TF=1.0} and \texttt{compare\_ic=ring}. Runtime for this run: spectral $3.620$\,s, NN $0.0975$\,s, speedup $37.13\times$.
...
Comparison at 8 aligned frames for $(h-h_0,q_x,q_y)$ with \texttt{compare\_TF=3.0} and \texttt{compare\_ic=random}. Both rollouts start after warmup time $T=4.0$. Final rollout metrics for this run: mean L1 error $0.034743$, max-frame L1 error $0.077908$, spectral runtime $116.512$\,s, NN runtime $6.8015$\,s, speedup $17.13\times$.
