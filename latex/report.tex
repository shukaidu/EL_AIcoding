...
Comparison at 8 aligned frames for $(h-h_0,q_x,q_y)$ with \texttt{compare\_TF=2.0} and \texttt{compare\_ic=random}. Both rollouts start after warmup time $T=5.0$. Final rollout metrics for this run: mean L1 error $0.020156$, max-frame L1 error $0.042984$, spectral runtime $25.362$\,s, NN runtime $7.1750$\,s, speedup $3.5\times$.
