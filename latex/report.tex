...
Comparison at 6 output times over $t\in[0,2]$ with \texttt{compare\_t\_end=2.0}. Runtime for this run: FV total $1.716$\,s, NN total $0.3326$\,s, speedup $5.2\times$.
...
Comparison at 6 aligned frames with \texttt{compare\_TF=2.0} and \texttt{compare\_ic=ring}. Runtime for this run: spectral $7.262$\,s, NN $0.2074$\,s, speedup $35.0\times$.
...
Comparison at 8 aligned frames for $(h-h_0,q_x,q_y)$ with \texttt{compare\_TF=4.0} and \texttt{compare\_ic=random}. Both rollouts start after warmup time $T=5.0$. Final rollout metrics for this run: mean L1 error $0.035294$, max-frame L1 error $0.055150$, spectral runtime $55.091$\,s, NN runtime $5.3823$\,s, speedup $10.2\times$.
