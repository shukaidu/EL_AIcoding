...
\begin{table}[H]
  ...
  \begin{tabular}{ll}
    ...
    Steps per saved frame $T_{\mathrm{screen}}$ & 5 \\
    Patch half-width $n_{\mathrm{st}}$ & 18 \\
    Interior width $n_{\mathrm{wd}}$ & 32 \\
    Viscosity $\nu_h$ & 0 \\
...
Comparison at 6 output times over $t\in[0,2]$ with \texttt{compare\_t\_end=2.0}. Runtime for this run: FV total $1.712$\,s, NN total $0.3085$\,s, speedup $5.5\times$.
...
Comparison at 6 aligned frames with \texttt{compare\_TF=2.0} and \texttt{compare\_ic=ring}. Runtime for this run: spectral $7.291$\,s, NN $0.1678$\,s, speedup $43.5\times$.
...
Comparison at 8 aligned frames for $(h-h_0,q_x,q_y)$ with \texttt{compare\_TF=4.0} and \texttt{compare\_ic=random}. Both rollouts start after warmup time $T=5.0$. Final rollout metrics for this run: mean L1 error $0.034346$, max-frame L1 error $0.056487$, spectral runtime $54.743$\,s, NN runtime $4.8993$\,s, speedup $11.2\times$.
