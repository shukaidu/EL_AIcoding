...
def _wave2d_nonlinear_single_run(args):
    """Top-level for multiprocessing pickle on Windows. args = (seed, ic, TF, TSCREEN, nx, ny, Lx, Ly, g, h0, f_coriolis, nu_h, nu_q, nudging_coeff, integrator, dt). Returns (t_hist, U_hist)."""
